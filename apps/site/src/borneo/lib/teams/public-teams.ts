...
import type { PublicTeam, PublicTeamMember } from "@borneo/lib/teams/types";

export type { PublicTeam, PublicTeamMember } from "@borneo/lib/teams/types";
export { TEAM_CATEGORIES } from "@borneo/lib/teams/types";
