...
/** Numbered Amazing Race groups — assigned on /amazing-race, max 4 people each. */
...
export const participants = pgTable("participants", {
  ...
  /** Amazing Race page — group number + leader flag (max 4 per group). */
  amazingRaceLeader: boolean("amazing_race_leader").notNull().default(false),
  /** Amazing Race page — numbered group assignment. */
