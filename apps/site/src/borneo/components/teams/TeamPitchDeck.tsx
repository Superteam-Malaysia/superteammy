...
/**
 * Staging note: per-team Canva designIds are private (403 on embed), so we keep
 * the hosted slide images. Flip `USE_CANVA_EMBEDS` after sharing each design as
 * “Anyone with the link”.
 */
const USE_CANVA_EMBEDS = false;
...
export function TeamPitchDeck({ team }: TeamPitchDeckProps) {
  ...
  if (!USE_CANVA_EMBEDS && slides.length > 0) {
    return (
