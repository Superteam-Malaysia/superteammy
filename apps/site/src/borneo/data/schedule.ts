...
export const SCHEDULE_DAYS: ScheduleDay[] = [
  ...
  },
  {
    ...
    venueNote: "Breakfast at Sheraton, then bus to Voco. Standings announced this morning.",
    events: [
      {
        id: "d3-bus",
        title: "Bus to Voco",
      ...
      {
        id: "d3-office-hours",
        title: "Office hours · Get your real users",
        start: "14:00",
        end: "15:30",
        description: "Teams go out to get their real users.",
        color: "azure",
      },
      {
        id: "d3-regroup",
        title: "Regroup · Roast My Pitch",
        start: "15:30",
        end: "17:00",
      ...
      {
        id: "d3-wrap",
        title: "Wrap · Free-and-easy evening",
        start: "17:00",
        end: "18:30",
        description:
          "Roam Kuching for dinner. Building continues after dinner.",
        color: "wisp",
      },
      {
        id: "d3-monke-meetup",
  ...
  },
  {
    ...
    events: [
      ...
      {
        id: "d4-cutoff",
        title: "HARD CUTOFF · Pitch deck submission",
        start: "18:00",
        end: "18:15",
        description: "Deck due by 18:00. Amazing Race milestones remain open until 10 Sept 23:59 MYT.",
        color: "byte",
        isDeadline: true,
      },
      {
