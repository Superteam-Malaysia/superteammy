...
export const SPEAKER_DAYS: SpeakerDay[] = [
  {
    ...
    sessions: [
      { id: "s2-open", title: "Opening", speaker: "Superteam MY", kind: "opening", start: "10:00", end: "10:10" },
      {
        ...
        title: "SOCOE keynote",
        speaker: "Leon",
        organization: "SOCOE · Executive Directorate",
        kind: "keynote",
        start: "10:10",
        end: "10:25",
      },
      ...
      {
        id: "s2-meteora",
        title: "Meteora Ecosystem — Opportunities for Everyone",
        speaker: "Vesper",
  ...
  },
  {
    ...
    sessions: [
      ...
      {
        id: "s3-users",
        title: "Office hours — teams go out for real users",
        speaker: "All teams",
        kind: "program",
        start: "14:00",
        end: "15:30",
...
> = {
  ...
  "s3-elfa-sales": {
    avatar: withBasePath("/speakers/ming-yang.jpg"),
    twitter: "elfa_ai",
  },
  "s4-virtuals": {
