...
export default function SubmissionsPage() {
  return (
    <main className="site-main site-main--stack">
      ...
      <SectionArticle className="border border-[color:var(--color-transparent-wisp-10)] py-6 md:py-8">
        ...
        <ul className="mt-10 grid gap-6 md:grid-cols-3 list-none">
          ...
          <li>
            <ActionCard
              title="Pitch deck"
              tone="mint"
              description="Upload before Wed 10 Sept, 12:00 AM MYT — same cutoff as Amazing Race."
            />
          </li>
          <li>
            <ActionCard
      ...
      <SectionArticle className="bg-[var(--color-wisp)]/5 border border-[color:var(--color-transparent-wisp-10)] py-6 md:py-10">
